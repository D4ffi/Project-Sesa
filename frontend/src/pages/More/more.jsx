        ...
        <div className="more-container">
            ...
            <header className="more-header">
                ...
                <div className="search-bar">
                    <input type="text" placeholder="Filtrar de lista..." />
            ...
            <div className="more-content">
                ...
                <div className="more-title-section">
                    <h1 className="more-title">Sesa Promo</h1>
                ...
                <div className="services-grid">
                    <div className="service-card">
                        <h2>Personalizacion de pedidos</h2>
                        <p>
                    ...
                    <div className="service-card">
                        ...
                        <p>
                            Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto.
                            Lorem Ipsum ha sido el texto de re
                        </p>
            ...
            <div className="bottom-left-decoration"></div>
        </div>
    );
};
